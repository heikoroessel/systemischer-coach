...
<div class="page">
  ...
  <div class="settings">
    ...
    <div class="voice-grid">
      <button class="voice-btn on" onclick="setVoice('coral',this)">
        <span class="voice-name">Coral</span>
        <span class="voice-desc">weiblich, warm</span>
      </button>
      <button class="voice-btn" onclick="setVoice('sage',this)">
        <span class="voice-name">Sage</span>
        <span class="voice-desc">weiblich, klar</span>
      </button>
      <button class="voice-btn" onclick="setVoice('ash',this)">
